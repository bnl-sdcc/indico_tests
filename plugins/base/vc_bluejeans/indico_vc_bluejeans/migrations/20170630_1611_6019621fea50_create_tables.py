...
def upgrade():
    op.execute(CreateSchema('plugin_vc_bluejeans'))
    op.create_table('bluejeans_extensions',
                    ...
                    schema='plugin_vc_bluejeans')


def downgrade():
    op.drop_table('bluejeans_extensions', schema='plugin_vc_bluejeans')
    op.execute(DropSchema('plugin_vc_bluejeans'))
