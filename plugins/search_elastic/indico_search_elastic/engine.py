...
from indico_search_elastic.entries import Author, ContributionEntry, EventEntry, SubContributionEntry


class ElasticRemoteSearch(object):
...
class ElasticSearchEngine(SearchEngine):
    ...
    def _make_obj_query(self):
        if isinstance(self.obj, db.m.Category) and not self.obj.is_root:
            ...
            # XXX: The old plugin prefixed this with 'AND ' but according to the elastic docs, AND is implied
